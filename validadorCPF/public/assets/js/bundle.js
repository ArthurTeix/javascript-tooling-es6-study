...
var ValidaCPF = /*#__PURE__*/function () {
  ...
  return _createClass(ValidaCPF, [{
    ...
    value: function éSequência() {
      // para impedir repetições (Ex: 111.111.111-11)
      return this.cpfLimpo.charAt(0).repeat(11) === this.cpfLimpo;
    }
  }, {
    key: "geraNovoCpf",
    value: function geraNovoCpf() {
      // cria novo cpf para comparar com o instanciado e checar
      var cpfSemDigitos = this.cpfLimpo.slice(0, -2); // será usado para gerar os dígitos do fim
    ...
    value: function geraDigito(cpfSemDigitos) {
      // faz o cálculo dos dois últimos dígitos do cpf
      var total = 0;
